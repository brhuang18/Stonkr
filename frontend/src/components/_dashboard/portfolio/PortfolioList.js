...
export default function PortfolioList() {
  ...
  React.useEffect(() => {
    ...
    axios.get(`http://127.0.0.1:8000/portfolios/overview${str}`, {
      headers: {
          ...
          <Table>
            ...
            <TableBody>
              {filteredData
                ...
                .map((row) => {
                  const { portfolio_id, portfolio_name, today_profit, privacy, today_profit_percentage, total_profit, total_profit_percentage, market_value } = row;

"""
Django settings for stonk_backend project.
...
ROOT_URLCONF = 'stonk_backend.urls'
...
WSGI_APPLICATION = 'stonk_backend.wsgi.application'
...
# Channels
ASGI_APPLICATION = 'stonk_backend.asgi.application'
